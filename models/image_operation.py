...
class ImageOperation:
    ...
    def log_transform(img: Image) -> Image:
        ...
        # ref: https://www.geeksforgeeks.org/log-transformation-of-an-image-using-python-and-opencv/
    ...
    @staticmethod
    def edge_detector(img: Image) -> Image:
        image = np.array(img)
        # Convert to Gray and Finds edges in an image using the Canny algorithm
    ...
    @staticmethod
    def edge_detector_pillow(img: Image) -> Image:
